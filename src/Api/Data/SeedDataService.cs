...
public static class SeedDataService
{
        ...
        UserManager<IdentityUser> userManager)
    {
        ...
        var user1 = await EnsureUser(userManager, Ids.User1, "agronomo@demo.com", "Demo@1234!", Api.Roles.Agronomo);
        var user2 = await EnsureUser(userManager, Ids.User2, "tecnico@demo.com",  "Demo@1234!", Api.Roles.Tecnico);
        await EnsureUser(userManager, "seed-user-0001-0001-000000000003", "produtor@demo.com", "Demo@1234!", Api.Roles.Produtor);
    ...
    static async Task SeedWorkspaces(AppDbContext db, string ownerId1, string ownerId2)
    {
        ...
        db.Workspaces.AddRange(
            new Workspace
            {
                ...
                Description = "Workspace compartilhado entre agronomo e tecnico para a Fazenda Cerrado Verde."
            },
            new Workspace
            {
        ...
        db.WorkspaceMembers.AddRange(
            ...
            new WorkspaceMember { Id = Ids.WsMember2, WorkspaceId = Ids.Workspace1, UserId = ownerId2,  Role = WorkspaceRole.Tecnico, JoinedAt = DateTime.UtcNow.AddDays(-25) },
