...
public enum WorkspaceRole { Owner, Gestor, Operador, Consulta }
...
public class WorkspaceMember : BaseEntity
{
    ...
    public WorkspaceRole Role        { get; set; } = WorkspaceRole.Consulta;
...
public class WorkspaceInvite : BaseEntity
{
    ...
    public WorkspaceRole Role            { get; set; } = WorkspaceRole.Operador;
